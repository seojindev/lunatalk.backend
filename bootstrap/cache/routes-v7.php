...
app('router')->setCompiledRoutes(
  ...
  array (
    ...
    2 => 
    array (
      0 => '{^(?|/oauth/(?|tokens/([^/]++)(*:32)|clients/([^/]++)(?|(*:58))|personal\\-access\\-tokens/([^/]++)(*:99))|/api/(?|other/v1/media/([^/]++)/([^/]++)/create(*:154)|front/v1/(?|auth/(?|([^/]++)/phone\\-auth(*:202)|([0-9]+)/phone\\-auth\\-confirm(*:239))|p(?|roduct/([^/]++)/(?|detail(*:277)|search\\-list(*:297)|create\\-review(*:319))|ages/(?|product(?|\\-category/([^/]++)/list(*:370)|/([^/]++)/detail(*:394))|cart/(?|([^/]++)/create(*:426)|([0-9]+)/delete(*:449)))))|admin\\-front/v1/(?|p(?|roduct/(?|([^/]++)/(?|de(?|tail\\-product(?|\\-category(*:537)|(*:545))|lete\\-product(?|\\-category(*:580)|(*:588)))|update\\-product(?|\\-category(*:626)|(*:634)))|([0-9]+)/detail\\-product\\-reviews(*:677)|([0-9]+)/answer\\-product\\-review(*:717))|age\\-manage/([^/]++)/(?|de(?|tail\\-main\\-slide(*:772)|lete\\-(?|best\\-item(*:799)|new\\-item(*:816)))|update\\-main\\-slide(*:845)|create\\-(?|best\\-item(*:874)|new\\-item(*:891))))|site\\-manage/([^/]++)/(?|update\\-notice(*:941)|detail\\-notice(*:963))|user\\-manage/([^/]++)/(?|de(?|tail\\-user(*:1012)|lete\\-user(*:1031))|update\\-user(?|(*:1056)|\\-p(?|assword(*:1078)|hone\\-number(*:1099)))))))/?$}sDu',
    ),
    3 => 
    array (
      32 => 
