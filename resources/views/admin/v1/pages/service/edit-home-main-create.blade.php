                                ...
                                <div class="card o-hidden border-0 shadow-lg my-5">
                                    <div class="card-body">
                                        <form>
                                            ...
                                            <div class="form-group">
                                                <label class="control-label" for="edit-status">게시</label>
...
@push('pageIncludeScripts')
        ...
        <script src="{{URL::asset('assets/resource/admin-pages-script/service-edit-home-dropzone.js')}}?t={{ time() }}"></script>
@endpush
...
@push('pageLoadScript')
        ...
        <script>
            serviceEditHomeMainCreatePageFunction.pageStart();
        </script>
@endpush
