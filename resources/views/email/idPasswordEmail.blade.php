...
<body>
    <div style="border-top: 2px solid #333; border-bottom: 2px solid #333; padding:40px 0">
        ...
        <h2 style="margin-bottom: 20px;">회원님의 아이디 <span style="fon-size:12px; font-weight: 300; color:#333">안내입니다.</span></h2>
        <p>안녕하세요.</p>
        <p>요청하신 회원님의 아이디 내역입니다.</p>
        <p>확인후 로그인하세요.</p>
        <div>
            <p>아이디 :</p>
            @foreach($details['loginIds'] as $loginId)
