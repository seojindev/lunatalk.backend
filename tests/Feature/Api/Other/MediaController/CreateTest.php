...
namespace Tests\Feature\Api\Other\MediaController;
...
class CreateTest extends BaseCustomTestCase
{
    ...
    // 라우터 에러.
    public function test_other_media_네임_없을때_라우터_에러()
    {
    ...
    // 이미지 없을때.
    public function test_other_media_카테고리명_없을떄_라우터_에러()
    {
        $this->expectException(NotFoundHttpException::class);
    ...
    // 이미지 파일 없을떄.
    public function test_other_media_파일_없이_요청()
    {
    ...
    // 등록 가능한 이미지 파일 아닐때.
    public function test_other_media_이미지외_다른_파일_요청()
    {
        $this->expectException(ClientErrorException::class);
    ...
    // 이미지 사이즈 초과.
    public function test_other_media_이미지_사이즈_초과_요청()
    {
        $this->expectException(ClientErrorException::class);
