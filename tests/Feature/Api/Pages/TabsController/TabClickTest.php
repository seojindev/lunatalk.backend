...
class TabClickTest extends BaseCustomTestCase
{
    ...
    public function test_pages_tabs_click_코드값_없이_요청()
    {
        $this->expectException(NotFoundHttpException::class);

        $click_code = "";
        $this->withHeaders($this->getTestAccessTokenHeader())->json('PUT', "/api/v1/pages/tabs/{$click_code}/click");
    }

    public function test_pages_tabs_click_코드값_에러()
    {
    ...
    public function test_pages_tabs_click_main_top_정상()
    {
    ...
    public function test_pages_tabs_click_main_best_정상()
    {
        $selectHomeMain = HomeMains::with(['product'])->where('gubun', config('extract.homeMainGubun.mainBestItem.code'))->inRandomOrder()->first()->toArray();
    ...
    public function test_pages_tabs_click_main_hot_정상()
    {
    ...
    public function test_pages_tabs_click_product_category_정상()
    {
